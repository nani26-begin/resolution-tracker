...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Could not join. Try again.');
            setIsLoading(false);
        }
    };
        ...
        <div className="min-h-screen bg-[#F0F4F8] flex flex-col items-center justify-center p-6 pb-20">
            ...
            >
                <div className="flex flex-col items-center mb-10 text-center">
                    ...
                    <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest mt-2">Your journey starts here</p>
                </div>
                ...
                <div className="bg-white p-10 rounded-[48px] shadow-strong">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            {isLoading ? 'CREATING...' : (
                                <>
                                    START QUEST <ArrowRight size={24} strokeWidth={3} />
                                </>
                            )}
                        </button>
                    </form>
                    ...
                    <div className="mt-8 text-center px-4">
                        <p className="text-slate-400 text-sm font-bold">
                            Already a player? <Link to="/login" className="text-blue-600">Sign In</Link>
                        </p>
                    </div>
                </div>

                <p className="mt-12 text-center text-slate-300 font-bold text-[10px] uppercase tracking-widest">LevelUp 2026 • Kakumanu Ajit Babu</p>
            </motion.div>
        </div>
    );
};
